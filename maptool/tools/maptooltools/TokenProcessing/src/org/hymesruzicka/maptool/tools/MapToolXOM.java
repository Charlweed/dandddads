 ...
 * @author chymes
 */
public class MapToolXOM {

    private static final Logger LOG = Logger.getLogger(MapToolXOM.class.getName());
    ...
    public MapToolXOM(String inputFileName) {
    ...
    /**
     * <p>
     * Parses the input XML file, and sets the xomDocument to the result. The
     * xomDocument is null if the source file could not be parsed.</p>
     * This method my only called once on any instance of MapToolXOM.
     *
     * @return This instance.
     */
    public final MapToolXOM build() {
        if (_xomDocument != null) {
            throw new IllegalStateException("Maptool XOM my only be built once.");
        }
